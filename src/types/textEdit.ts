...
export type TextEditFormatCommand =
  | 'bold'
  | 'italic'
  | 'strikethrough'
  | 'underline'
...
export interface TextEditFormatPayload {
  command: TextEditFormatCommand;
}

export interface TextEditFontPayload {
  fontFamily: string;
}

export interface TextEditFontSizePayload {
  fontSize: number;
}

export interface TextEditFontOptionsResponse {
  fonts: string[];
...
export interface TextEditMessage {
  ...
  | 'TEXT_EDIT_GET_STATS'
  | 'TEXT_EDIT_HIGHLIGHT'
  | 'TEXT_EDIT_APPLY_FORMAT'
  | 'TEXT_EDIT_APPLY_FONT_FAMILY'
  | 'TEXT_EDIT_APPLY_FONT_SIZE'
  | 'TEXT_EDIT_GET_FONT_OPTIONS'
  | 'TEXT_EDIT_START'
  | 'TEXT_EDIT_END';
  data?: unknown;
  timestamp: number;
