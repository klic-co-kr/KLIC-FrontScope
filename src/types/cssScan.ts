...
/**
 * CSS Scan 도구 데이터 (content → sidepanel 전송용)
 */
export interface CssScanToolData {
  element: {
    tagName: string;
    id?: string;
    classes: string[];
  ...
  /** 전체 computed styles (Show all 토글용) */
  allComputedStyles: Record<string, string>;
  inlineStyles: Record<string, string>;
  matchedRules: CSSRule[];
  pseudoClassRules: CSSRule[];
  inheritedProperties: Record<string, string>;
  colors: ColorInfo[];
  font: FontInfo | null;
